                  ...
                  <table id="table"
                    ...
                    <thead>
                      <tr>
                        ...
                        <th data-field="name" data-halign="center" data-align="center" data-sortable="true">菜单名称</th>
                        <th data-field="parentName" data-halign="center" data-align="center" data-sortable="true">上级菜单</th>
                        <th data-field="icon" data-formatter="formatIcon" data-sortable="true" data-halign="center" data-align="center">菜单图标</th>
                        <th data-field="url" data-sortable="true" data-halign="center" data-align="center">菜单URL</th>
                        <th data-field="perms" data-sortable="true" data-halign="center" data-align="center">授权标识</th>
                        <th data-field="type" data-formatter="formatType" data-sortable="true" data-halign="center" data-align="center">类型</th>
                        <th data-field="orderNum" data-sortable="true" data-halign="center" data-align="center">排序号</th>
          ...
          <form id="form">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
              	...
              	<input type="text" name='parentName' class="form-control" style="cursor:pointer;" onclick="showMenuTree()" readonly="readonly" placeholder="一级菜单"/>
              </div>
            </div>
            <div id="menuTable">
	            <div class="hr-line-dashed"></div>
            ...
            <div id="buttonTable">
	            ...
	            <div class="form-group">
	              ...
	              <div class="col-sm-6">
	                <input type="text" class="form-control" name="perms"  placeholder="多个用逗号分隔，如：user:list,user:create">
	              </div>
	            </div>
            </div>
            <div id="catalogTable">
	            ...
	            <div class="form-group">
	              ...
	              <div class="col-sm-6">
	              	<div class="input-group m-b"> <span class="input-group-btn">
	              	 <button type="button" class="btn btn-primary" onclick="layer_show_url('菜单图标','${base}/admin/sys/menu_icon.html','800','600')" title="图标">选择</button>
